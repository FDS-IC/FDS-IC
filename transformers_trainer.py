...
class NerDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        try:
            ...
            print(f"Error: Label {e} not found in label2id. Please check your data.")
            raise
...
class BertNer(nn.Module):
    def __init__(self,
        ...
        self.lstm_hiden = 128
        self.max_seq_len = max_seq_len
        self.bilstm = nn.LSTM(hidden_size, self.lstm_hiden, 2, bidirectional=True, batch_first=True, dropout=0.1)
...
training_args = TrainingArguments(
    ...
    eval_strategy="steps",  # 替换 evaluation_strategy
    logging_steps=1,
    max_grad_norm=1,
    eval_steps=10,
    do_eval=True,
